Staminia.messages = {
  warning_p2_stronger_than_p1: "Player 2 is stronger than Player 1. Try to switch the players.",
  warning_p1_stamina_se: Staminia.format("There is a very little chance that Player 1, playing as a defender, could generate a bad stamina event at or after minute {0}."),
  warning_p2_stamina_se: Staminia.format("There is a very little chance that Player 2, playing as a defender, could generate a bad stamina event if he enters the field at or before minute {0}."),
